...
class __TwigTemplate_a4b21f009e91080544f9c1c934e6e3ea9f4c7d49a14a13637b39682da16b8833 extends Template
{
    private $source;
    private $macros = [];
    ...
    <p>
        ...
        echo "</strong>.<br/>
        Une confirmation de l'erreur vient de vous être envoyée par email à l'adresse ";
        // line 10
...
";
    ...
    {
        return array (  92 => 12,  87 => 10,  83 => 9,  77 => 8,  73 => 6,  66 => 5,  53 => 3,  36 => 1,);
    }
...
{% block content %}
    ...
    <p>
        ...
        Il semblerait que votre paiement est échoué pour votre commande n°{{ order.reference }}</strong>.<br/>
        Une confirmation de l'erreur vient de vous être envoyée par email à l'adresse {{ order.user.email }}</strong>.
    </p>
    <a href=\"{{ path('order') }}\" class=\"btn btn-success\">Réessayer le paiement</a>
{% endblock %}
", "order_cancel/index.html.twig", "C:\\wamp64\\www\\SiteMarchand\\templates\\order_cancel\\index.html.twig");
    }
}
